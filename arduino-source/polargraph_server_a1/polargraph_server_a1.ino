...
Servo penHeight;
const int DEFAULT_DOWN_POSITION = 180; //90
const int DEFAULT_UP_POSITION = 90; //180
...
const byte PEN_HEIGHT_SERVO_PIN = 24; //UNL2003 driver uses pin 9 //6 //24 //1 (change to 1 from 24 to allow for serial)
